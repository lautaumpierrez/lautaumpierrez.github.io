          ...
          <div className="column is-6">
            <div className="container has-text-centered-touch">
              ...
              <div className="level is-mobile">
                <a href="https://api.whatsapp.com/send?phone=598098115938&text=Hola%21%20Quisiera%20contactarme%20con%20Lautaro%20Umpiérrez" className="btn level-item" style={{marginRight: 20,backgroundColor: '#2ecc71'}}>
                  <div className="level is-mobile">
